...
const Task = ({setAddedTasks,tasks}) =>{
    const {task,date,comments} = tasks
 ...
 <div className="mx-5 my-10 m-3 px-5 py-10 rounded-xl bg-white shadow-md">
    ...
    <p className="font-bold mb-3 text-gray-700 uppercase ">
        Task: {" "}
        <span className="font-normal normal-case">{task}</span>
    </p>
    </div>
    <div className="mb-5 flex">
    <p className="font-bold mb-3 text-gray-700 uppercase">
    ...
    <div className="flex justify-between mt-10">
        <button className="py-2 px-10 bg-indigo-600 hover:bg-indigo-700 text-white font-bold uppercase rounded-lg" type="button">Edit</button>
